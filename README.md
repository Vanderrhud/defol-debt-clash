...
* [`docs/combat_rules.md`](docs/combat_rules.md) — Sistem combat, input touchscreen, dan mekanik Bunga Meter
* [`docs/roadmap.md`](docs/roadmap.md) — Alur kerja dan milestone pengembangan
* [`characters/osman.md`](characters/osman.md) — Karakter: Master Osman (Kebab Cyber-Chef)
* [`characters/aylin.md`](characters/aylin.md) — Karakter: Aylin (Senior Debt Collector)
* [`assets_spec/audio_visual.md`](assets_spec/audio_visual.md) — Checklist kebutuhan sprite, visual FX, dan SFX
